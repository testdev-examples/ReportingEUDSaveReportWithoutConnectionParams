...
Namespace WinEUDSaveReportWithoutConnectionParams
	Friend Class CustomConnectionStorageService
		...
		Public ReadOnly Property CanSaveConnection() As Boolean
			Get
				Return True
			End Get
		End Property
		...
		Private Sub CreateDefaultConnection()
			...
			End If
		End Sub
		Public Sub SaveConnection(ByVal connectionName As String, ByVal connection As IDataConnection, ByVal saveCredentials As Boolean)
